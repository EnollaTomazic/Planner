...
export default {
  ...
  borderSubtle: "var(--ring)",
  dangerForeground: "var(--highlight)",
  dangerTintForeground: "var(--danger-foreground)",
  surfaceMuted: "var(--muted) / 0.12",
  surfaceHover: "var(--muted) / 0.18",
  accent2Foreground: "var(--accent-foreground)",
