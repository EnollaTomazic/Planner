...
| spacing-0125 | calc(var(--spacing-1) / 8) |
| spacing-025 | calc(var(--spacing-1) / 4) |
| spacing-05 | calc(var(--spacing-1) / 2) |
| spacing-075 | calc(var(--spacing-1) * 0.75) |
| spacing-1 | 4px |
| spacing-2 | 8px |
| spacing-3 | 12px |
| spacing-4 | 16px |
...
| pillar-wave-start | var(--accent-1) |
| pillar-wave-end | var(--accent-2) |
| pillar-wave-shadow | var(--accent-1) / 0.35 |
| pillar-trading-start | var(--lav-deep) |
| pillar-trading-end | var(--accent-1) |
...
| aurora-p | var(--accent-1) |
| aurora-p-light | 272 80% 85% |
| icon-fg | 250 96% 84% |
| accent-overlay | hsl(var(--accent-1)) |
| ring-contrast | hsl(var(--ring)) |
| glow-active | hsl(var(--glow)) |
| neon | var(--glow) |
| neon-soft | hsl(var(--neon)) |
| focus | var(--theme-ring) |
| card-hairline | color-mix(in oklab, hsl(var(--border)) 78%, hsl(var(--foreground)) 22%) |
| hairline-w | 1px |
...
| texture-scanline-opacity | 0.045 |
...
| glitch-noise-primary | hsl(var(--accent-1) / var(--texture-grain-opacity, 0.05)) |
| glitch-noise-secondary | hsl(var(--ring) / var(--texture-grain-opacity, 0.05)) |
| glitch-noise-contrast | hsl(var(--foreground) / var(--texture-grain-opacity, 0.05)) |
...
| backdrop-grid-primary | var(--accent-1) |
| backdrop-grid-secondary | var(--accent-1) |
...
| glitch-accent-color | hsl(var(--accent-1) / 0.35) |
...
| glitch-overlay-opacity-card | var(--theme-scanline-opacity-moderate, 0.08) |
...
| drip-surface | color-mix(in oklab, hsl(var(--accent-1)) 18%, hsl(var(--background)) 82%) |
...
| gradient-glitch-primary | linear-gradient(135deg, hsl(var(--accent-1) / 0.35), hsl(var(--accent-2) / 0.3)) |
| gradient-glitch-overlay | linear-gradient(120deg, hsl(var(--accent-1) / 0.12) 0%, transparent 58%, hsl(var(--ring) / 0.16) 100%), var(--card-overlay-scanlines) |
| gradient-glitch-rail | linear-gradient(180deg, hsl(var(--primary) / 0.6) 0%, hsl(var(--accent-1) / 0.45) 45%, hsl(var(--ring) / 0.6) 100%) |
...
| gradient-hero-topline | linear-gradient(90deg, hsl(var(--accent-1) / 0.28), transparent 55%, hsl(var(--accent-2) / 0.32)) |
| gradient-hero-action-halo | radial-gradient(120% 95% at 50% 0%, hsl(var(--accent-1) / 0.24), transparent 65%) |
...
| surface-rail-accent | linear-gradient(180deg, hsl(var(--accent-1)), hsl(var(--primary))) |
...
| glitch-rgb-shift | drop-shadow(calc(var(--glitch-chromatic-offset-light) * -1) 0 0 hsl(var(--accent-1) / 0.45)) drop-shadow(var(--glitch-chromatic-offset-light) 0 0 hsl(var(--ring) / 0.45)) |
