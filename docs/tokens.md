...
| glitch-noise-primary | hsl(var(--accent-1) / var(--texture-grain-opacity, 0.04)) |
| glitch-noise-secondary | hsl(var(--ring) / var(--texture-grain-opacity, 0.04)) |
| glitch-noise-contrast | hsl(var(--foreground) / var(--texture-grain-opacity, 0.04)) |
...
| glitch-overlay-opacity-card | var(--theme-scanline-opacity-moderate, 0.06) |
