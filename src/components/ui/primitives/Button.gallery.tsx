...
const BUTTON_STATES: readonly ButtonStateSpec[] = [
  ...
  },
  {
    ...
    code:
      "<Button className=\"ring-2 ring-[var(--ring-contrast)] shadow-glow-md [outline:var(--spacing-0-5)_solid_var(--ring-contrast)] [outline-offset:var(--spacing-0-5)]\">Focus</Button>",
  },
  {
    id: "active",
    name: "Active",
