  ...
  return (
    <button
      ...
      className={cn(
        ...
        "rounded-[var(--control-radius)] transition focus-visible:ring-2 focus-visible:ring-[var(--ring-contrast)] focus-visible:shadow-glow-md focus-visible:[outline:var(--spacing-0-5)_solid_var(--ring-contrast)] focus-visible:[outline-offset:var(--spacing-0-5)]",
