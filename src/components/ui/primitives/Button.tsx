...
>((props, ref) => {
  ...
  if (variant === "primary") {
    const basePrimaryShadows = {
      ...
      "--btn-primary-hover-shadow": `0 var(--spacing-0-5) calc(var(--space-3) / 2) calc(-1 * var(--spacing-0-25)) hsl(var(${toneColorVar}) / 0.25)`,
      "--btn-primary-active-shadow": `inset 0 0 0 var(--spacing-0-25) hsl(var(${toneColorVar}) / 0.6)`,
