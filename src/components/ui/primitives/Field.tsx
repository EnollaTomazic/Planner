...
const FIELD_ROOT_BASE = cn(
  ...
  "[--neo-shadow:var(--shadow-inner-md)] [--neo-shadow-hover:var(--shadow-inner-lg)]",
  "focus-visible:[--neo-shadow:var(--shadow-inner-lg)] focus-within:[--neo-shadow:var(--shadow-inner-lg)]",
  ...
  "data-[disabled=true]:[--neu-surface:hsl(var(--card))] data-[disabled=true]:[--neo-shadow:var(--shadow-inner-md)]",
