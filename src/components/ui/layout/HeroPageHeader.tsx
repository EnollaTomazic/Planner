// src/components/ui/layout/HeroPageHeader.tsx
"use client";
...
type HeroPageHeaderElement = Extract<
  keyof React.JSX.IntrinsicElements,
  "header" | "section" | "article" | "aside" | "main" | "div" | "nav"
>;

type HeroPageHeaderElementProps = Omit<
  React.HTMLAttributes<HTMLElement>,
  "className" | "children"
>;

type HeroPageHeaderFrameElement = React.ElementRef<typeof NeomorphicHeroFrame>;
...
export interface HeroPageHeaderBaseProps<
  HeaderKey extends string = string,
  HeroKey extends string = string,
> extends HeroPageHeaderElementProps {
...
export type HeroPageHeaderProps<
  HeaderKey extends string = string,
  HeroKey extends string = string,
> = HeroPageHeaderBaseProps<HeaderKey, HeroKey> &
  React.RefAttributes<HeroPageHeaderFrameElement>;

export type HeroPageHeaderRef = HeroPageHeaderFrameElement;

/**
 * HeroPageHeader — combines <Header> and <Hero> within a neomorphic frame.
 *
 * Used for top-of-page introductions with optional actions.
 */
const HeroPageHeaderInner = <
  HeaderKey extends string = string,
  HeroKey extends string = string,
>(
  {
  ...
  ref: React.ForwardedRef<HeroPageHeaderFrameElement>,
) => {
  const Component: HeroPageHeaderElement = as ?? "section";
...
const HeroPageHeaderComponent = React.forwardRef<
  HeroPageHeaderFrameElement,
  HeroPageHeaderBaseProps<HeaderKey, HeroKey>
>(HeroPageHeaderInner);

HeroPageHeaderComponent.displayName = "HeroPageHeader";

export const HeroPageHeader = HeroPageHeaderComponent as <
  HeaderKey extends string = string,
  HeroKey extends string = string,
>(
  props: HeroPageHeaderProps<HeaderKey, HeroKey>,
