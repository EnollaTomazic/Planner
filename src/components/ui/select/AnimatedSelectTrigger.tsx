...
export function AnimatedSelectTrigger({
  ...
  const triggerCls = cn(
    ...
    "focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-contrast)] focus-visible:shadow-glow-md focus-visible:[outline:var(--spacing-0-5)_solid_var(--ring-contrast)] focus-visible:[outline-offset:var(--spacing-0-5)]",
    "transition-colors duration-quick ease-out motion-reduce:transition-none",
    buttonClassName,
  );

  const containerCls = cn(
    "group inline-flex rounded-[var(--control-radius)] border border-[var(--ring-contrast)] focus-within:ring-2 focus-within:ring-[var(--ring-contrast)] focus-within:ring-offset-0 focus-within:shadow-glow-md",
    containerClassName,
  );
