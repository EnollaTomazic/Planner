...
const ADJUST_BTN_CLASS =
  "absolute top-[var(--space-2)] sm:-top-[var(--space-4)] rounded-full bg-background/40 backdrop-blur shadow-glow transition-transform duration-200 hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-ring";
          ...
          <div className="relative mx-auto w-full max-w-sm rounded-[var(--radius-2xl)] border border-card-hairline/60 bg-background/30 p-[var(--space-8)] backdrop-blur-xl shadow-card">
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 grid place-items-center">
                <div className="text-title font-semibold tabular-nums text-foreground drop-shadow-[0_0_var(--space-2)_hsl(var(--neon-soft))] transition-transform duration-200 group-hover:translate-y-0.5 sm:text-title-lg">
            ...
            <div className="mt-6 w-full">
              <div className="relative h-2 w-full rounded-full bg-background/20 shadow-neo-inset">
                ...
                <div
                  className="h-full rounded-full bg-[linear-gradient(90deg,hsl(var(--accent)),hsl(var(--accent-2)))] shadow-glow transition-[width] duration-200 ease-linear"
                  style={{ width: `${pct}%` }}
                />
              </div>
            ...
            <div className="mt-6 flex w-full flex-wrap justify-center gap-2 overflow-x-auto">
              {!running ? (
                <SegmentedButton
                  className="inline-flex min-w-[4.5rem] items-center gap-2 rounded-full px-4 py-2 transition-colors duration-200 ease-in-out"
                  onClick={start}
                  title="Start"
                >
                  <Play />
              ...
              <SegmentedButton
                className="inline-flex items-center gap-2 rounded-full px-4 py-2 transition-colors duration-200 ease-in-out"
                onClick={reset}
                title="Reset"
              >
                <RotateCcw />
