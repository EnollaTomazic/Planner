        ...
        },
        {
          ...
          "states": [
            ...
            },
            {
              "id": "focus",
              "name": "Focus",
              "code": "<Button className=\"ring-2 ring-[var(--ring-contrast)] shadow-glow-md [outline:var(--spacing-0-5)_solid_var(--ring-contrast)] [outline-offset:var(--spacing-0-5)]\">Focus</Button>",
              "preview": {
        ...
        },
        {
          ...
          "states": [
            ...
            },
            {
              "id": "focus",
              "name": "Focus",
              "code": "<IconButton className=\"ring-2 ring-[var(--ring-contrast)] shadow-glow-md [outline:var(--spacing-0-5)_solid_var(--ring-contrast)] [outline-offset:var(--spacing-0-5)]\" aria-label=\"Focus\">\n  <Plus />\n</IconButton>",
              "preview": {
        ...
        },
        {
          ...
          "states": [
            ...
            },
            {
              "id": "focus",
              "name": "Focus",
              "code": "<Input className=\"ring-2 ring-[var(--ring-contrast)] shadow-glow-md [outline:var(--spacing-0-5)_solid_var(--ring-contrast)] [outline-offset:var(--spacing-0-5)]\" placeholder=\"Focus\" />",
              "preview": {
        ...
        },
        {
          ...
          "states": [
            ...
            },
            {
              "id": "focus-visible",
              "name": "Focus-visible",
              "code": "<TabBar\n  items={[\n    { key: \"today\", label: \"Today\" },\n    { key: \"focus\", label: \"Focus-visible\", className: \"outline-[var(--spacing-0-5)_solid_var(--ring-contrast)] outline-offset-[var(--spacing-0-5)] ring-2 ring-[var(--ring-contrast)] shadow-glow-md\" },\n    { key: \"backlog\", label: \"Backlog\" },\n  ]}\n  value=\"today\"\n  onValueChange={() => {}}\n  ariaLabel=\"Tab state preview\"\n/>",
              "preview": {
