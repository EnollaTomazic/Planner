...
function SpecCard({
  ...
  const cardClassName = cn(
    ...
    "transition-[transform,box-shadow,filter] duration-200 ease-standard motion-reduce:transition-none",
        ...
        {code ? (
          <button
            ...
            className={cn(
              ...
              "transition-[transform,box-shadow,background,filter] duration-200 ease-standard motion-reduce:transition-none",
              ...
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-card",
              "before:pointer-events-none before:absolute before:-inset-px before:rounded-full before:border before:border-[hsl(var(--ring)/0.35)] before:opacity-0 before:transition-opacity before:duration-200 before:ease-standard",
              "focus-visible:before:opacity-100",
              "after:pointer-events-none after:absolute after:inset-0 after:rounded-full after:bg-[radial-gradient(120%_95%_at_50%_0%,hsl(var(--accent)/0.24),transparent_65%)] after:opacity-0 after:transition-opacity after:duration-200 after:ease-standard",
