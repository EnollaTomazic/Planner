...
const shellBase = cn(
  ...
  "hover:bg-accent/10 hover:ring-2 hover:ring-[var(--focus)]",
  "focus-visible:bg-accent/15 focus-visible:ring-2 focus-visible:ring-[var(--focus)]",
  "active:bg-accent/20 active:ring-2 active:ring-[var(--focus)]",
