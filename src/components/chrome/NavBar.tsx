            ...
            <li key={href} className="relative">
              <Link
                ...
                className={cn(
                  ...
                  "before:absolute before:inset-y-[calc(var(--space-1)/2)] before:inset-x-[var(--space-1)] before:-z-10 before:rounded-full before:bg-surface/70 before:opacity-0 before:shadow-glow-sm before:transition-opacity before:duration-quick before:ease-out",
