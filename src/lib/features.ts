...
const rawGlitchLanding = process.env.NEXT_PUBLIC_FEATURE_GLITCH_LANDING;
...
const glitchLandingPreviewEnabled = parseBooleanFlag(rawGlitchLanding, true);

export {
  depthThemeEnabled,
  glitchLandingPreviewEnabled,
  organicDepthEnabled,
  svgNumericFilters,
};
