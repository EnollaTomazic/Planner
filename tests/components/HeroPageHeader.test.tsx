...
import { HeroPageHeader } from "@/components/ui/layout/HeroPageHeader";

afterEach(cleanup);

describe("HeroPageHeader", () => {
  const baseHeader = {
    heading: "Overview",
  ...
  it("renders a single semantic header element by default", () => {
    const { container } = render(
      <HeroPageHeader header={baseHeader} hero={baseHero} />,
    );
  ...
  it("calms the hero typography by default", () => {
    render(<HeroPageHeader header={baseHeader} hero={baseHero} />);
  ...
  it("omits the actions slot container when actions resolve to false", () => {
    const { container } = render(
      <HeroPageHeader header={baseHeader} hero={baseHero} actions={false} />,
    );
