...
export const rootVariables: VariableDefinition[] = [
  ...
  },
  {
    ...
    value: [
      "",
      "0 calc(var(--spacing-0-25)) var(--space-1) hsl(var(--neon) / 0.55),",
      "calc(var(--spacing-0-5)) calc(var(--spacing-0-5) * 0.75) calc(var(--space-3)) hsl(var(--neon) / 0.35),",
      "calc(var(--spacing-0-5) * -1) calc(var(--spacing-0-5) * 1.5) calc(var(--space-4) + var(--space-1) / 2) hsl(var(--neon) / 0.22),",
      "calc(var(--spacing-0-5) * 1.25) calc(var(--spacing-0-5) * -1.25) calc(var(--space-5)) hsl(var(--neon) / 0.16)",
    ],
  },
  {
...
const rawThemes: ThemeDefinition[] = [
  {
    ...
    variables: [
      ...
      { name: "accent-contrast", value: "274 80% 92%" },
      ...
      { name: "surface", value: "282 64% 17%" },
      { name: "surface-2", value: "280 48% 25%" },
  ...
  },
  {
    ...
    variables: [
      { name: "background", value: "210 16% 14%" },
      { name: "foreground", value: "32 42% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "212 20% 18%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "26 92% 82%" },
      ...
      { name: "surface", value: "212 22% 19%" },
      { name: "surface-2", value: "212 20% 27%" },
  ...
  },
  {
    ...
    label: "Noir",
    variables: [
      { name: "background", value: "352 68% 11%" },
      { name: "foreground", value: "0 0% 94%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "352 62% 15%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "184 90% 82%" },
      ...
      { name: "surface", value: "352 56% 17%" },
      { name: "surface-2", value: "352 36% 25%" },
  ...
  },
  {
    ...
    label: "Oceanic",
    variables: [
      { name: "background", value: "216 48% 15%" },
      { name: "foreground", value: "204 22% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "218 34% 19%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "204 92% 82%" },
      ...
      { name: "surface", value: "218 30% 19%" },
      { name: "surface-2", value: "218 26% 25%" },
  ...
  },
  {
    ...
    label: "Kitten",
    variables: [
      { name: "background", value: "334 92% 10%" },
      { name: "foreground", value: "332 28% 97%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "334 86% 14%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "340 88% 86%" },
      ...
      { name: "surface", value: "334 74% 16%" },
      { name: "surface-2", value: "334 60% 22%" },
  ...
  },
  {
    ...
    label: "Hardstuck",
    variables: [
      { name: "background", value: "120 58% 10%" },
      { name: "foreground", value: "120 60% 72%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "120 52% 13%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "120 92% 88%" },
      ...
      { name: "surface", value: "120 32% 15%" },
      { name: "surface-2", value: "120 34% 20%" },
  ...
  },
  {
    ...
    variables: [
      { name: "background", value: "258 78% 11%" },
      { name: "foreground", value: "196 28% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "260 68% 15%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-contrast", value: "304 100% 92%" },
      ...
      { name: "surface", value: "260 60% 17%" },
      { name: "surface-2", value: "260 50% 23%" },
