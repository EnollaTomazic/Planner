...
export const rootVariables: VariableDefinition[] = [
  ...
  { name: "surface-muted", value: "248 24% 13%" },
  { name: "surface-raised", value: "248 26% 18%" },
  { name: "surface-hover", value: "248 28% 22%" },
  { name: "border-subtle", value: "253 26% 20%" },
  { name: "border-strong", value: "253 30% 32%" },
  {
    name: "ring-accent",
    value: "color-mix(in oklab, hsl(var(--accent)) 65%, hsl(var(--ring)) 35%)",
  },
  {
    name: "focus-outline",
    value: [
  ...
  { name: "chip-gap", value: "var(--spacing-1)" },
  { name: "chip-radius", value: "var(--radius-full)" },
  { name: "chip-pad-x", value: "var(--spacing-2)" },
  { name: "chip-pad-y", value: "var(--spacing-0-75)" },
...
export const themes: ThemeDefinition[] = [
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "280 52% 18%" },
      { name: "border-strong", value: "280 60% 32%" },
      ...
      { name: "surface-muted", value: "282 60% 12%" },
      { name: "surface-raised", value: "280 54% 20%" },
      { name: "surface-hover", value: "280 58% 24%" },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "212 20% 18%" },
      { name: "border-strong", value: "212 26% 34%" },
      { name: "line", value: "var(--border)" },
      ...
      { name: "surface-muted", value: "212 20% 14%" },
      { name: "surface-raised", value: "212 22% 22%" },
      { name: "surface-hover", value: "212 24% 25%" },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "352 38% 18%" },
      { name: "border-strong", value: "352 48% 32%" },
      { name: "line", value: "var(--border)" },
      ...
      { name: "surface-muted", value: "352 48% 12%" },
      { name: "surface-raised", value: "352 40% 20%" },
      { name: "surface-hover", value: "352 44% 24%" },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "218 24% 18%" },
      { name: "border-strong", value: "218 28% 32%" },
      { name: "line", value: "var(--border)" },
      ...
      { name: "surface-muted", value: "218 28% 14%" },
      { name: "surface-raised", value: "218 28% 20%" },
      { name: "surface-hover", value: "218 30% 24%" },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "334 62% 18%" },
      { name: "border-strong", value: "334 72% 32%" },
      { name: "line", value: "var(--border)" },
      ...
      { name: "surface-muted", value: "334 66% 12%" },
      { name: "surface-raised", value: "334 58% 18%" },
      { name: "surface-hover", value: "334 62% 22%" },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "border-subtle", value: "120 36% 16%" },
      { name: "border-strong", value: "120 44% 30%" },
      { name: "line", value: "var(--border)" },
      ...
      { name: "surface-muted", value: "120 30% 10%" },
      { name: "surface-raised", value: "120 34% 16%" },
      { name: "surface-hover", value: "120 36% 19%" },
