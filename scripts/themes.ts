...
export const rootVariables: VariableDefinition[] = [
  ...
  { name: "backdrop-grid-primary", value: "var(--accent-1)" },
  { name: "backdrop-grid-secondary", value: "var(--accent-1)" },
  ...
  { name: "glitch-accent-color", value: "hsl(var(--accent-1) / 0.35)" },
  ...
  { name: "glitch-noise-primary", value: "hsl(var(--accent-1) / 0.048)" },
  { name: "glitch-noise-secondary", value: "hsl(var(--ring) / 0.042)" },
  { name: "glitch-noise-contrast", value: "hsl(var(--foreground) / 0.04)" },
  {
  ...
  },
  {
    ...
    value: ["inset 0 0 0 calc(var(--space-1) / 4)", "hsl(var(--accent-1) / 0.6)"],
  },
...
const rawThemes: ThemeDefinition[] = [
  {
    ...
    variables: [
      ...
      { name: "accent-1", value: "274 78% 64%" },
      { name: "accent-1-contrast", value: "274 80% 90%" },
      { name: "accent-2", value: "152 96% 56%" },
      { name: "accent-1-foreground", value: "0 0% 100%" },
      { name: "accent-1-soft", value: "274 78% 22%" },
      { name: "glow", value: "152 100% 68%" },
      { name: "muted", value: "280 52% 16%" },
      { name: "muted-foreground", value: "280 24% 76%" },
      { name: "surface", value: "282 64% 15%" },
      ...
      { name: "glitch-static-opacity", value: "0.03" },
      ...
      { name: "backdrop-drip-2", value: "var(--accent-1)" },
  ...
  },
  {
    ...
    variables: [
      { name: "background", value: "210 16% 13%" },
      { name: "foreground", value: "32 42% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "212 20% 17%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "26 92% 44%" },
      { name: "accent-1-contrast", value: "26 92% 82%" },
      { name: "accent-2", value: "168 72% 32%" },
      { name: "accent-1-foreground", value: "0 0% 100%" },
      { name: "accent-1-soft", value: "26 92% 18%" },
      { name: "glow", value: "28 96% 62%" },
      { name: "muted", value: "212 18% 22%" },
      { name: "muted-foreground", value: "212 20% 70%" },
      { name: "surface", value: "212 22% 18%" },
      ...
      { name: "glitch-static-opacity", value: "0.027" },
  ...
  },
  {
    ...
    label: "Noir",
    variables: [
      { name: "background", value: "352 68% 10%" },
      { name: "foreground", value: "0 0% 94%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "352 62% 14%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "184 86% 35%" },
      { name: "accent-1-contrast", value: "184 90% 82%" },
      { name: "accent-2", value: "32 92% 38%" },
      { name: "accent-1-foreground", value: "0 0% 100%" },
      { name: "accent-1-soft", value: "184 86% 14%" },
      { name: "glow", value: "356 90% 62%" },
      { name: "muted", value: "352 34% 18%" },
      { name: "muted-foreground", value: "352 24% 68%" },
      { name: "surface", value: "352 56% 16%" },
      ...
      { name: "glitch-static-opacity", value: "0.021" },
      { name: "glitch-noise-primary", value: "hsl(var(--ring) / 0.05)" },
      { name: "glitch-noise-secondary", value: "hsl(var(--accent-1) / 0.044)" },
      { name: "glitch-noise-contrast", value: "hsl(var(--foreground) / 0.042)" },
  ...
  },
  {
    ...
    label: "Oceanic",
    variables: [
      { name: "background", value: "216 48% 14%" },
      { name: "foreground", value: "204 22% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "218 34% 18%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "204 92% 32%" },
      { name: "accent-1-contrast", value: "204 92% 82%" },
      { name: "accent-2", value: "230 78% 36%" },
      { name: "accent-1-foreground", value: "0 0% 100%" },
      { name: "accent-1-soft", value: "204 92% 14%" },
      { name: "glow", value: "194 94% 64%" },
      { name: "muted", value: "218 24% 17%" },
      { name: "muted-foreground", value: "218 16% 74%" },
      { name: "surface", value: "218 30% 18%" },
  ...
  },
  {
    ...
    label: "Kitten",
    variables: [
      { name: "background", value: "334 92% 9%" },
      { name: "foreground", value: "332 28% 97%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "334 86% 13%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "340 86% 36%" },
      { name: "accent-1-contrast", value: "340 88% 88%" },
      { name: "accent-2", value: "194 90% 40%" },
      { name: "accent-1-foreground", value: "0 0% 100%" },
      { name: "accent-1-soft", value: "340 86% 14%" },
      { name: "glow", value: "336 94% 64%" },
      { name: "muted", value: "334 64% 18%" },
      { name: "muted-foreground", value: "334 26% 74%" },
      { name: "surface", value: "334 74% 14%" },
      ...
      { name: "glitch-fringe", value: "6deg" },
      { name: "glitch-static-opacity", value: "0.0255" },
  ...
  },
  {
    ...
    label: "Hardstuck",
    variables: [
      { name: "background", value: "120 58% 9%" },
      { name: "foreground", value: "120 60% 72%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "120 52% 15%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "120 92% 58%" },
      { name: "accent-1-contrast", value: "120 92% 90%" },
      { name: "accent-2", value: "120 76% 22%" },
      { name: "accent-2-foreground", value: "120 32% 94%" },
      { name: "accent-1-foreground", value: "0 0% 8%" },
      { name: "text-on-accent", value: "hsl(var(--hardstuck-foreground))" },
      { name: "accent-1-soft", value: "120 90% 16%" },
      ...
      { name: "glitch-static-opacity", value: "0.021" },
      { name: "glitch-noise-primary", value: "hsl(var(--ring) / 0.048)" },
      { name: "glitch-noise-secondary", value: "hsl(var(--accent-1) / 0.044)" },
      {
        name: "glitch-noise-contrast",
        value: "hsl(var(--hardstuck-foreground) / 0.044)",
      },
  ...
  },
  {
    ...
    variables: [
      { name: "background", value: "258 78% 10%" },
      { name: "foreground", value: "196 28% 96%" },
      { name: "text", value: "var(--foreground)" },
      { name: "card", value: "260 68% 16%" },
      { name: "panel", value: "var(--card)" },
      ...
      { name: "accent-1", value: "304 100% 68%" },
      { name: "accent-1-contrast", value: "304 100% 92%" },
      { name: "accent-2", value: "188.7 89.6% 69.8%" },
      { name: "accent-3", value: "257.5 85.7% 72.5%" },
      { name: "accent-1-foreground", value: "0 0% 6%" },
      { name: "accent-1-soft", value: "304 100% 20%" },
      { name: "muted", value: "260 48% 18%" },
      { name: "muted-foreground", value: "260 22% 78%" },
      { name: "surface", value: "260 60% 15%" },
      ...
      { name: "glitch-static-opacity", value: "0.06" },
      ...
      { name: "backdrop-blob-3", value: "var(--accent-1)" },
      { name: "backdrop-blob-shadow", value: "var(--accent-1)" },
      ...
      { name: "backdrop-drip-3", value: "var(--accent-1)" },
      { name: "backdrop-drip-shadow", value: "var(--accent-1)" },
      { name: "blob-radius-soft", value: "calc(var(--radius-2xl) + var(--spacing-2))" },
      {
        name: "grid-lines",
        value: [
