...
export const GALLERY_USAGE_TRACKED_PATTERNS = [
  "src/app/**/*.{ts,tsx}",
...
export const MANIFEST_HEADER_LINES = [
  "// Auto-generated by scripts/build-gallery-usage.ts",
  "// Do not edit directly.",
] as const;

export const REQUIRED_MANIFEST_EXPORTS = [
...
async function main(): Promise<void> {
  const trackedFiles = await fg([...GALLERY_USAGE_TRACKED_PATTERNS], {
    cwd: rootDir,
    absolute: true,
  });
  ...
  await writeManifest(
    [...new Set([...trackedFiles, manifestOutput, usageFile])],
  );
...
if (invokedPath) {
  const invokedUrl = pathToFileURL(path.resolve(invokedPath)).href;
