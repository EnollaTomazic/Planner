...
> **Prerequisite:** Install [Node.js](https://nodejs.org) >=20.15 and <21 to match the repository engines. Other releases may still run, but expect reduced support and additional warnings.
